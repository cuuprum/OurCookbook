package iak.intermediate.hydrargyrum.ourcookbook.adapter;

/**
 * Created by hydrargyrum on 2/22/2018.
 * Adapter untuk Recyler View
 */
...
public abstract class ListAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public ListAdapter(int _mLayout, Class<VH> _mViewHolder, Class<T> _mModelClass, ArrayList<T> _mData){
        this.mLayout = _mLayout;
        this.mViewHolderClass = _mViewHolder;
        this.mModelClass = _mModelClass;
        this.mData = _mData;
    }

    public void swapData(ArrayList<T> _mData){
        this.mData = _mData;
